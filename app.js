const quiz = [
  {
    ...
    question: '漫画について露伴先生はこの様に語っている。「『マンガ』とは想像や空想で 描かれていると思われがちだが 実は違う！自分の見たことや 体験したこと感動したことを描いてこそおもしろくなるんだ！」  そんな露伴先生が部屋にいた蜘蛛を見つけ、ペンで内臓を抉り苦しむ様子を観察した後、露伴先生のセリフと行動はは？',
